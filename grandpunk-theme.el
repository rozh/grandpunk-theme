;;; grandpunk-theme.el --- Grand Punk color theme for Emacs > 24

;; Copyright 2013, rozh

;; Author: rozh
;; Keywords: color theme grand punk faces
;; URL: https://github.com/rozh/grandpunk-theme
...
(deftheme grandpunk "Grand Punk, a dark theme for Emacs24+")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(linum ((,class (:background ,background :foreground ,normal))))
   ...
   `(mode-line
     ((,class (:foreground ,cyan
                           ...
                           :box (:line-width -1)))))
   `(mode-line-inactive
     ((,class (:foreground ,yellow-darker
                           :background ,alt-background
                           :box (:line-width -1)))))
   `(minibuffer-prompt ((,class (:foreground ,magenta))))
   `(region ((,class (:background ,magenta-dark))))
   `(secondary-selection ((,class (:background ,alt-background))))

   `(header-line ((,class (:foreground ,magenta
                                       :background ,alt-background
...
;; (provide 'grandpunk)
(provide-theme 'grandpunk)

;;; grandpunk-theme.el ends here
